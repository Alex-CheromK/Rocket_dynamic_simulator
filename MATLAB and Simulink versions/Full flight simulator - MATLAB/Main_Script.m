...
%%
subplot(3,2,1);
plot(Time,StateVecTraj(:,1))
subplot(3,2,3);
plot(Time,StateVecTraj(:,2))
subplot(3,2,5);
plot(Time,StateVecTraj(:,3))
subplot(3,2,2);
plot(Time,StateVecTraj(:,4))
subplot(3,2,4);
plot(Time,StateVecTraj(:,5))
subplot(3,2,6);
plot(Time,StateVecTraj(:,6))
